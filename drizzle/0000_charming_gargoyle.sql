...
ALTER TABLE "loading_list_extraction_results" ADD CONSTRAINT "loading_list_extraction_results_group_id_employee_capture_groups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."employee_capture_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
